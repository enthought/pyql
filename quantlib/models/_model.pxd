...
from quantlib.instruments._option cimport Option
...
cdef extern from 'ql/models/model.hpp' namespace 'QuantLib':
    ...
    cdef cppclass AffineModel:
        ...
        Real discountBondOption(Option.Type type, Real strike, Time maturity, Time bondMaturity)
        Real discountBondOption(Option.Type type, Real strike, Time maturity, Time bondStart, Time bondMaturity)
