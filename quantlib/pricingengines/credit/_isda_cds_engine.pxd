...
from quantlib.termstructures.credit._credit_helpers cimport CdsHelper
...
cdef extern from 'ql/pricingengines/credit/isdacdsengine.hpp' namespace 'QuantLib':
    ...
    cdef cppclass IsdaCdsEngine(PricingEngine):
        ...
        IsdaCdsEngine(
            vector[shared_ptr[CdsHelper]] & probabilityHelpers,
            Real recoveryRate,
            vector[shared_ptr[RateHelper]] & rateHelpers,
            optional[bool] includeSettlementDateFlows, # = none
